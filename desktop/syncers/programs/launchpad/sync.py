...
from . import db
from .types import Launchpad, Root, Folder, split_pages
from ...config import watch_config, LAUNCHPAD_CONFIG_PATH, load_launchpad_config
...
def sync_launchpad() -> bool:
    ...
    with Session(engine) as session:
        ...
        for page, remote_page in zip(pages, list(root)[offset:]):
